...
toolDiscreteChoice <- function(input, generalModelPar, updatedEndoCosts, helpers) {
  ...
  # calculate all VS3 shares- vehicle type level --------------------------------------------------------------------
  ...
  # calculate all S3S2 shares - subsectorL3 level --------------------------------------------------------------------
  ...
  # calculate all S2S1 shares - subsectorL2 level --------------------------------------------------------------------
  ...
  # calculate all S1S shares - subsectorL1 level --------------------------------------------------------------------
