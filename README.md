...
R package **edgeTransport**, version **3.1.3.9002**
...
Hoppe J, Dirnaichner A, Rottoli M, Muessel J, Hagen A, Pietzcker R (2025). "edgeTransport: Prepare EDGE Transport Data for the REMIND model." Version: 3.1.3.9002, <https://github.com/pik-piam/edgeTransport>.
