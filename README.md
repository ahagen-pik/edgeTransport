...
R package **edgeTransport**, version **2.16.6.9001**
...
Hoppe J, Dirnaichner A, Rottoli M, Muessel J, Hagen A (2025). "edgeTransport: Prepare EDGE Transport Data for the REMIND model." Version: 2.16.6.9001, <https://github.com/pik-piam/edgeTransport>.
